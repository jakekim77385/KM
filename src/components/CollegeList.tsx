...
const colleges: College[] = [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    programYears: 8,
    strengths: ['Need-blind 국제학생', 'BS→Brown Med 보장', '인문의학 융합', '연구 자유'],
    applyUrl: 'https://www.brown.edu/academics/medical/plme/',
    deadlineEA: undefined,
    deadlineED: '11월 1일',
    deadlineRD: '1월 1일',
    notes: '⭐ 최우선 지원. Need-blind + 의대 보장. ED 지원 시 합격률 상승. 실납부 ~$60K/년.',
    researchFit: 92,
    preMedRank: 15,
    intlFriendly: true,
  },
  ...
  },
  {
    ...
    applyUrl: 'https://admissions.case.edu/apply/programs/ppsp/',
    deadlineRD: '12월 1일',
    notes: '⚠️ 국제학생 PPSP 가능 여부 확인 필요. admission@case.edu 문의 후 지원 결정.',
    researchFit: 78,
    intlFriendly: false,
  },
  {
    id: 'bu-meddep',
    name: 'Boston University — MEDDEP',
    shortName: 'BU MEDDEP',
    category: 'bsmd',
    tier: 'reach',
    location: 'Boston, MA',
    ...
    aidPolicy: 'merit',
    aiMatchScore: 76,
    programName: 'Medical Early Deadline Program (MEDDEP)',
    programYears: 8,
    strengths: ['Boston 위치', 'BU Med 연계', 'MCAT 면제', '국제학생 Merit 가능'],
    applyUrl: 'https://www.bu.edu/admissions/academics/special-programs/meddep/',
    deadlineED: '11월 1일',
    deadlineRD: '1월 4일',
    notes: 'Merit 장학금 일부 가능. Boston 의료 생태계 최강. 연구 + 임상 경험 풍부.',
    researchFit: 80,
    intlFriendly: true,
  },
  {
    id: 'rpi-accelerated-med',
    name: 'Rensselaer Polytechnic — Accelerated Physician-Scientist',
    shortName: 'RPI APS',
    category: 'bsmd',
    tier: 'match',
    location: 'Troy, NY',
    ...
    aidPolicy: 'merit',
    aiMatchScore: 64,
    programName: 'Accelerated Physician-Scientist Program',
    programYears: 7,
    strengths: ['STEM 기반 의학', '7년 단축', 'Albany Med 연계', '공학-의학 융합'],
    applyUrl: 'https://admissions.rpi.edu/undergraduate/program/accelerated-physician-scientist',
    deadlineED: '11월 1일',
    deadlineRD: '1월 15일',
    notes: 'STEM+의학 융합 지원자에게 적합. 꾸미 STEM 배경과 매칭.',
    researchFit: 72,
    intlFriendly: true,
  },
              ...
              {[
                {
                  ...
                  items: [
                    'Brown PLME — ED1 지원 (11/1)',
                    'BU MEDDEP — ED2 혹은 RD',
                    'CWRU PPSP — 국제학생 가능 확인 후',
                    'UConn SPM — Need-aware지만 비교적 저렴',
                    'RPI APS — STEM 강점 활용',
                  ],
                },
                {
          ...
          <div className="card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                ...
                { item: 'Brown PLME Essay 초안 작성 (Why Medicine, Why Brown)', done: false, color: 'var(--purple-400)' },
                ...
                { item: 'CWRU admission@case.edu 국제학생 PPSP 문의 이메일 발송', done: false, color: 'var(--amber-400)' },
